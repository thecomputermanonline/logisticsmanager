...
INSERT INTO settings (id, name, value, label, description) VALUES
	...
	(6, 'sender_invitation', 'webmaster@localhost', 'Invitation email is sent from:', ''),
	...
	(9, 'sender_signUp', 'webmaster@localhost', 'Activation email is sent from:', ''),
	...
	(11, 'sender_registerNewEmail', 'webmaster@localhost', 'Verification email is sent from:', '');
